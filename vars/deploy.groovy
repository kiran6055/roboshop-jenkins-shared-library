      ...
      stage('Run Deployment') {
        steps {
          sh '''
            ...
            aws autoscaling start-instance-refresh --auto-scaling-group-name ${env}-${component} --preferences '{"InstanceWarmup": 240, "MinHealthyPercentage": 50, "SkipMatching: false,}\'
